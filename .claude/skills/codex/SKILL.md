---
name: codex
description: Use when the user asks to run Codex CLI (codex exec, codex resume) or references OpenAI Codex for code analysis or asks for a professional review of a plan, branch, or PR.
---

# Codex Skill Guide

## Running a Task
1. Use `gpt-5.5` with `xhigh` reasoning effort by default.
